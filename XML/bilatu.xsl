                ...
                <main>
                    <xsl:for-each select="//departamentuak/departamentua">
                        <div class="langdepKutxa">
                            ...
                            <select>
                                <xsl:variable name="departamentuId" select="@id" />
                                <xsl:for-each
                                    select="//langileak/langilea[@idDepartamentu = $departamentuId]">
                                    <option>
                                        <xsl:value-of select="izena" />
                                    </option>
                                </xsl:for-each>
        ...
        ulertzeko eta laguntzeko. Eskerrik asko Sprotify erabiltzeagatik!
                        ...
                        <div class="kategoriak">
                            ...
                            <ul>
                                ...
                                <li>
                                    <a href="eskaintzak.html">Audioak</a>
                                </li>
                            </ul>
                        </div>
                        <div class="kategoriak">
