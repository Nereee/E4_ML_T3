<?php
session_start();
$xml = simplexml_load_file("../XML/Datuak.xml");
...
<html lang="es">
  ...
  <body>
    ...
    <div class="langileak">
        <?php
        // Recorrer cada empleado en el XML y mostrar su imagen y nombre en un contenedor
        foreach ($xml->departamentuak->langilea as $langilea) {
            $irudia = $langilea->irudia;
            $izena = $langilea->izena;
            echo "<div class='langile-container'>";
            echo "<img src='$irudia' alt='Langile irudia'>";
            echo "<span class='langile-name'>$izena</span>";
            echo "</div>";
        }
        ?>
    </div>
