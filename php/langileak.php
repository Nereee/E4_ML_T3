...
<html lang="es">
  ...
  <body>
    ...
    <main>
      <!-- REVISAR PARA HACER CON XPATH -->
    <div class="langileak">
        <?php
        // Recorrer cada empleado en el XML y mostrar solo la imagen
        foreach ($xml->langileak->langilea as $langilea) {
            $irudia = $langilea->irudia; // Obtener la URL de la imagen del empleado
            $izena = $langilea->izena; // Obtener la URL de la imagen del empleado
